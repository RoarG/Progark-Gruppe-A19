...
public class BuildableTextureAtlas<S extends ITextureAtlasSource, T extends ITextureAtlas<S>> implements IBuildableTextureAtlas<S, T> {
	...
	/**
	 * @see {@link org.andengine.opengl.texture.atlas.bitmap.BuildableBitmapTextureAtlas#setTextureStateListener(org.andengine.opengl.texture.atlas.ITextureAtlas.ITextureAtlasStateListener)}
	 */
	@Deprecated
	@Override
