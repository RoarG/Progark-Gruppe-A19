...
public abstract class TextureAtlas<T extends ITextureAtlasSource> extends Texture implements ITextureAtlas<T> {
	...
	/**
	 * @see {@link org.andengine.opengl.texture.atlas.ITextureAtlas#setTextureStateListener(org.andengine.opengl.texture.atlas.ITextureAtlas.ITextureAtlasStateListener)}
	 */
	@Deprecated
	@Override
