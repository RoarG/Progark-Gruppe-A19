...
/**
 * The general workflow with a {@link org.andengine.opengl.texture.render.RenderTexture} is: {@link org.andengine.opengl.texture.render.RenderTexture#init(org.andengine.opengl.util.GLState)} -> {@link org.andengine.opengl.texture.render.RenderTexture#begin(org.andengine.opengl.util.GLState)} -> {@link org.andengine.opengl.texture.render.RenderTexture#end(org.andengine.opengl.util.GLState)} -> {@link org.andengine.opengl.texture.render.RenderTexture#destroy(org.andengine.opengl.util.GLState)}.
 *
 * (c) Zynga 2011
 *
...
public class RenderTexture extends Texture {
	...
	/**
	 * @param pGLState
	 * @throws org.andengine.opengl.exception.RenderTextureInitializationException when this {@link org.andengine.opengl.texture.render.RenderTexture} could not be initialized. The {@link org.andengine.opengl.exception.GLException} contains the error code. When this exception is throw, all cleanup will be automatically performed through {@link org.andengine.opengl.texture.render.RenderTexture#destroy(org.andengine.opengl.util.GLState)}.
	 */
	...
	/**
	 * @see {@link org.andengine.opengl.texture.render.RenderTexture#end(org.andengine.opengl.util.GLState)},
	 * 		{@link org.andengine.opengl.texture.render.RenderTexture#end(org.andengine.opengl.util.GLState, boolean, boolean}}.
	 */
	 ...
	 * 		{@link org.andengine.opengl.texture.render.RenderTexture#end(org.andengine.opengl.util.GLState, boolean, boolean}}.
	 *
	 * @param pColor the {@link org.andengine.util.color.Color} to clear this {@link org.andengine.opengl.texture.render.RenderTexture}.
	 */
	...
	/**
	 * @see {@link org.andengine.opengl.texture.render.RenderTexture#begin(org.andengine.opengl.util.GLState)},
	 * 		{@link org.andengine.opengl.texture.render.RenderTexture#begin(org.andengine.opengl.util.GLState, boolean, boolean)},
	 * 		{@link org.andengine.opengl.texture.render.RenderTexture#begin(org.andengine.opengl.util.GLState, org.andengine.util.color.Color)},
	 * 		{@link org.andengine.opengl.texture.render.RenderTexture#begin(org.andengine.opengl.util.GLState, float, float, float, float)},
	 * 		{@link org.andengine.opengl.texture.render.RenderTexture#begin(org.andengine.opengl.util.GLState, boolean, boolean, org.andengine.util.color.Color)}.
	 * 		{@link org.andengine.opengl.texture.render.RenderTexture#begin(org.andengine.opengl.util.GLState, boolean, boolean, float, float, float, float)}.
	 */
