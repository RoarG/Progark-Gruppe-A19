...
/**
 * TODO Extract a common base class from {@link org.andengine.opengl.vbo.VertexBufferObject} and {@link org.andengine.opengl.vbo.ZeroMemoryVertexBufferObject} (due to significant code duplication).
...
public abstract class VertexBufferObject implements IVertexBufferObject {
	 ...
	 * @param pVertexBufferObjectAttributes to be automatically enabled on the {@link org.andengine.opengl.shader.ShaderProgram} used in {@link org.andengine.opengl.vbo.VertexBufferObject#bind(org.andengine.opengl.shader.ShaderProgram)}.
	 */
