...
public abstract class ZeroMemoryVertexBufferObject implements IVertexBufferObject {
	...
	/**
	 * When a non <code>null</code> {@link java.nio.ByteBuffer} is returned by this function, it is guaranteed that {@link org.andengine.opengl.vbo.ZeroMemoryVertexBufferObject#releaseByteBuffer(java.nio.ByteBuffer)} is called.
	 * @return a {@link java.nio.ByteBuffer} to be passed to {@link org.andengine.opengl.vbo.ZeroMemoryVertexBufferObject#onPopulateBufferData(java.nio.ByteBuffer)}.
	 */
