...
public interface ITouchArea {
	...
	/**
	 * This method only fires if this {@link org.andengine.entity.scene.ITouchArea} is registered to the {@link Scene} via {@link Scene#registerTouchArea(org.andengine.entity.scene.ITouchArea)}.
