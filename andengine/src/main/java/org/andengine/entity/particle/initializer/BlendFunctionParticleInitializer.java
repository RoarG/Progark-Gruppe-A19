...
/**
 * Sets the blend function used to draw the {@link org.andengine.entity.particle.Particle} during its lifespan. Only applicable to {@link org.andengine.entity.shape.Shape}s.
 * 
...
public class BlendFunctionParticleInitializer<T extends IShape> implements IParticleInitializer<T> {
	...
	/**
	 * Blend function set for each spawned {@link org.andengine.entity.particle.Particle}. Use {@link android.opengl.GLES20} constants for setting functions.
	 */
