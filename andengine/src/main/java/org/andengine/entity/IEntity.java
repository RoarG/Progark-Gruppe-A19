...
public interface IEntity extends IDrawHandler, IUpdateHandler, IDisposable {
	 ...
	 * @return all children (recursively!) that match the supplied {@link org.andengine.entity.IEntityMatcher}.
	 */
	public ArrayList<IEntity> query(final IEntityMatcher pEntityMatcher);
	/**
	 * @param pEntityMatcher
	 * @return the first child (recursively!) that matches the supplied {@link org.andengine.entity.IEntityMatcher} or <code>null</code> if none matches..
	 */
	 ...
	 * @param pEntityMatcher
	 * @return the first child (recursively!) that matches the supplied {@link org.andengine.entity.IEntityMatcher} or <code>null</code> if none matches..
	 * @throws ClassCastException when the supplied {@link org.andengine.entity.IEntityMatcher} matched an {@link org.andengine.entity.IEntity} that was not of the requested subtype.
	 */
	 ...
	 * In contrast to {@link org.andengine.entity.IEntity#sortChildren()} this method is particularly useful to avoid multiple sorts per frame.
	...
	/**
	 * Will only be performed if {@link org.andengine.entity.IEntity#isCullingEnabled()} is true.
	 *
